...
export function AgentWhiteboard({ challengeId, locale, diagram, expanded, busy, onExplain, onToggleExpand }: Props) {
  ...
  const labels = locale === 'zh'
    ? { title: 'Agent 白板讲解', subtitle: '回答后自动生成 Markdown / HTML 白板', explain: '重新生成', clear: '清空', expand: expanded ? '还原' : '展开' }
    : { title: 'Agent whiteboard', subtitle: 'Auto-generates Markdown / HTML boards after each answer', explain: 'Regenerate', clear: 'Clear', expand: expanded ? 'Restore' : 'Expand' }
