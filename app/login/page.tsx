    ...
    <div className="relative min-h-screen overflow-hidden bg-slate-50 px-4 py-10">
      ...
      >
        ...
        <a
          ...
          download
          className="mb-5 flex w-full items-center justify-center gap-2 rounded-xl bg-indigo-500 px-4 py-3 text-sm font-semibold text-white transition hover:bg-indigo-600"
        >
