...
// challenge.html files with attribution, so users see the same description and
// examples while the current WTT judge still runs CPU-sim payloads.
export const aiKernelSpecs: AiKernelSpec[] = [
  {"id": "ai-vector-add", "slug": "ai-vector-add", "title": "Vector Addition", "difficulty": "easy", "source_slug": "1_vector_add", "function": "ai_vector_add", "op": "vector_add", "tags": ["ai-kernel", "cpu-sim", "vector-add"]},
  ...
  {"id": "ai-silu", "slug": "ai-silu", "title": "Sigmoid Linear Unit", "difficulty": "easy", "source_slug": "52_silu", "function": "ai_silu", "op": "silu", "tags": ["ai-kernel", "cpu-sim", "silu"]},
  {"id": "ai-swiglu", "slug": "ai-swiglu", "title": "Swish-Gated Linear Unit", "difficulty": "easy", "source_slug": "54_swiglu", "function": "ai_swiglu", "op": "swiglu", "tags": ["ai-kernel", "cpu-sim", "swiglu"]},
  ...
  {"id": "ai-interleave", "slug": "ai-interleave", "title": "Interleave Arrays", "difficulty": "easy", "source_slug": "63_interleave", "function": "ai_interleave", "op": "interleave", "tags": ["ai-kernel", "cpu-sim", "interleave"]},
  {"id": "ai-geglu", "slug": "ai-geglu", "title": "Gaussian Error Gated Linear Unit", "difficulty": "easy", "source_slug": "65_geglu", "function": "ai_geglu", "op": "geglu", "tags": ["ai-kernel", "cpu-sim", "geglu"]},
  ...
  {"id": "ai-sigmoid", "slug": "ai-sigmoid", "title": "Sigmoid Activation", "difficulty": "easy", "source_slug": "68_sigmoid", "function": "ai_sigmoid", "op": "sigmoid", "tags": ["ai-kernel", "cpu-sim", "sigmoid"]},
  ...
  {"id": "ai-gemm", "slug": "ai-gemm", "title": "General Matrix Multiplication (GEMM)", "difficulty": "medium", "source_slug": "22_gemm", "function": "ai_gemm", "op": "gemm", "tags": ["ai-kernel", "cpu-sim", "gemm"]},
  ...
  {"id": "ai-attn-w-linear-bias", "slug": "ai-attn-w-linear-bias", "title": "Attention with Linear Biases", "difficulty": "medium", "source_slug": "55_attn_w_linear_bias", "function": "ai_attn_w_linear_bias", "op": "alibi_attention", "tags": ["ai-kernel", "cpu-sim", "alibi-attention"]},
  {"id": "ai-fp16-batched-matmul", "slug": "ai-fp16-batched-matmul", "title": "FP16 Batched Matrix Multiplication", "difficulty": "medium", "source_slug": "57_fp16_batched_matmul", "function": "ai_fp16_batched_matmul", "op": "batched_matmul", "tags": ["ai-kernel", "cpu-sim", "batched-matmul"]},
  ...
  {"id": "ai-rope-embedding", "slug": "ai-rope-embedding", "title": "Rotary Positional Embedding", "difficulty": "medium", "source_slug": "61_rope_embedding", "function": "ai_rope_embedding", "op": "rope", "tags": ["ai-kernel", "cpu-sim", "rope"]},
  ...
  {"id": "ai-moe-topk-gating", "slug": "ai-moe-topk-gating", "title": "MoE Top-K Gating", "difficulty": "medium", "source_slug": "67_moe_topk_gating", "function": "ai_moe_topk_gating", "op": "moe_topk", "tags": ["ai-kernel", "cpu-sim", "moe-topk"]},
  {"id": "ai-jacobi-stencil-2d", "slug": "ai-jacobi-stencil-2d", "title": "2D Jacobi Stencil", "difficulty": "medium", "source_slug": "69_jacobi_stencil_2d", "function": "ai_jacobi_stencil_2d", "op": "jacobi", "tags": ["ai-kernel", "cpu-sim", "jacobi"]},
  {"id": "ai-segmented-prefix-sum", "slug": "ai-segmented-prefix-sum", "title": "Segmented Exclusive Prefix Sum", "difficulty": "medium", "source_slug": "70_segmented_prefix_sum", "function": "ai_segmented_prefix_sum", "op": "prefix_sum", "tags": ["ai-kernel", "cpu-sim", "prefix-sum"]},
  ...
  {"id": "ai-adder-transformer", "slug": "ai-adder-transformer", "title": "Adder Transformer Inference", "difficulty": "medium", "source_slug": "76_adder_transformer", "function": "ai_adder_transformer", "op": "adder_transformer", "tags": ["ai-kernel", "cpu-sim", "adder-transformer"]},
  ...
  {"id": "ai-int4-matmul", "slug": "ai-int4-matmul", "title": "INT4 Weight-Only Quantized MatMul", "difficulty": "medium", "source_slug": "81_int4_matmul", "function": "ai_int4_matmul", "op": "int4_matmul", "tags": ["ai-kernel", "cpu-sim", "int4-matmul"]},
  ...
  {"id": "ai-multi-agent-sim", "slug": "ai-multi-agent-sim", "title": "Multi-Agent Simulation", "difficulty": "hard", "source_slug": "14_multi_agent_sim", "function": "ai_multi_agent_sim", "op": "multi_agent", "tags": ["ai-kernel", "cpu-sim", "multi-agent"]},
  ...
  {"id": "ai-kmeans-clustering", "slug": "ai-kmeans-clustering", "title": "K-Means Clustering", "difficulty": "hard", "source_slug": "20_kmeans_clustering", "function": "ai_kmeans_clustering", "op": "kmeans", "tags": ["ai-kernel", "cpu-sim", "kmeans"]},
  ...
  {"id": "ai-casual-attention", "slug": "ai-casual-attention", "title": "Causal Self-Attention", "difficulty": "hard", "source_slug": "53_casual_attention", "function": "ai_casual_attention", "op": "causal_attention", "tags": ["ai-kernel", "cpu-sim", "causal-attention"]},
  {"id": "ai-linear-attention", "slug": "ai-linear-attention", "title": "Linear Self-Attention", "difficulty": "hard", "source_slug": "56_linear_attention", "function": "ai_linear_attention", "op": "linear_attention", "tags": ["ai-kernel", "cpu-sim", "linear-attention"]},
  {"id": "ai-sliding-window-attn", "slug": "ai-sliding-window-attn", "title": "Sliding Window Self-Attention", "difficulty": "hard", "source_slug": "59_sliding_window_attn", "function": "ai_sliding_window_attn", "op": "window_attention", "tags": ["ai-kernel", "cpu-sim", "window-attention"]},
  ...
  {"id": "ai-gpt2-block", "slug": "ai-gpt2-block", "title": "GPT-2 Transformer Block", "difficulty": "hard", "source_slug": "74_gpt2_block", "function": "ai_gpt2_block", "op": "gpt_block", "tags": ["ai-kernel", "cpu-sim", "gpt-block"]},
...
function descriptionFor(spec: AiKernelSpec) {
  return leetGpuStatements[spec.source_slug]?.html || `AI Kernel / CPU-sim challenge. Implement \`${spec.function}(payload)\` in Python and return the exact JSON value requested by the examples.`
}
