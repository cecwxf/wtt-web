...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'settings.pluginCmdDesc': 'Claim 后复制并在插件宿主机终端执行，可自动写入 .env 并检查 autopoll 状态。',
  ...
  en: {
    ...
    'settings.pluginCmdDesc': 'After claim, copy and run this on the plugin host to update .env and check autopoll status.',
